...
<body>
  ...
  <nav class="navbar navbar-default" role="navigation">
    <div class="container">
      <div class="navbar-header">
        ...
        <!-- Logo text or image -->
        <a class="navbar-brand" href="index.html">K A I R O S  P R O J E C T S</a>
          ...
          <div class="item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animated fadeInDown">K A I R O S  P R O J E C T S</h2>
                <p class="animated fadeInUp">Coming Soon</p>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <p>Copyright &copy; Alstar. All rights reserved.<br> Kairos Projects</p>
          <div class="credits">
            <!--
